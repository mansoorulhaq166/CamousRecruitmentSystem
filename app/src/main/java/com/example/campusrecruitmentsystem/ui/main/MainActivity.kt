...
import com.example.campusrecruitmentsystem.ui.student.jobs.JobBrowsingActivity
import com.example.campusrecruitmentsystem.ui.student.jobs.JobsAppliedActivity
import com.example.campusrecruitmentsystem.ui.student.test.TakeTestActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonJobsPosted.setOnClickListener {
            val intent = Intent(this@MainActivity, JobsPostedActivity::class.java)
