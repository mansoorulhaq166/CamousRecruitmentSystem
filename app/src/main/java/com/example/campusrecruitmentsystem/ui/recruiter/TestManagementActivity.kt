...
import com.example.campusrecruitmentsystem.ui.recruiter.test.TestResultsActivity
...
class TestManagementActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnViewResults.setOnClickListener {
            startActivity(Intent(this@TestManagementActivity, TestResultsActivity::class.java))
        }
    }
}